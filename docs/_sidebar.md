...
- **COMMANDS**
  - [remember / recall / forget](commands/store.md)
  - [learn](commands/learn.md)
  - [shell hooks](commands/shell.md)
...
- **CONCEPTS**
  ...
  - [Context injection](concepts/context.md)
  - [Scopes](concepts/scopes.md)

- **CONNECTORS**
  - [Overview](connectors/index.md)
  - [Setup](connectors/setup.md)

- **BROWSER EXTENSION**
  - [Install & usage](extension/index.md)
